...
begin
 ...
 Label5.Caption:='Ungewöhnliche Kenntnisse (' + IntToStr(MPUk) + '/' + IntToStr(PUk) + ')';
 ...
 If klasse = 7 Then
  Begin
   ...
   faehigkeit('Kampf in Schlachtreihe',0,5,0,0,0,0,i,CheckListBox1);
       i:=1;
   faehigkeit('Kampf in Vollrüstung',1,15,1,61,0,0,i,CheckListBox1);
   ...
   faehigkeit('Wagenlenken',2,15,2,21,0,0,i,CheckListBox1);
       i:=2;
   faehigkeit('Beidhändiger Kampf',3,3,3,61,0,0,i,CheckListBox1);
   ...
   faehigkeit('Schießen vom Streitwagen',2,15,2,31,0,0,i,CheckListBox1);
   faehigkeit('Schiffsführung',5,8,5,31,7,61,i,CheckListBox1);
       i:=3;
   ...
   waffenfaehigkeit('Krummsäbel',02,5,1,31,2,11,i,CheckListBox2);
   ...
   waffenfaehigkeit('Stoßspeer',04,5,1,31,2,11,i,CheckListBox2);
   ...
   waffenfaehigkeit('Wurfspieß',14,5,1,61,2,21,i,CheckListBox2);
   ...
   waffenfaehigkeit('Großer Schild',25,1,1,61,0,00,i,CheckListBox2);
   ...
   waffenfaehigkeit('Bihänder',05,5,1,61,2,31,i,CheckListBox2);
   waffenfaehigkeit('Anderthalbhänder',05,5,1,31,2,21,i,CheckListBox2);
 ...
 Else
  faehigkeit('Erzählen',5,8,5,31,7,31,i,CheckListBox3);
 ...
 If heimat = 0 Then
  Begin
  faehigkeit('Geländelauf',3,10,3,31,0,0,i,CheckListBox3);
 ...
 Else
  ...
  faehigkeit('Glücksspiel',2,12,2,61,0,0,i,CheckListBox3);
 ...
 If heimat = 1 Then
  Begin
  faehigkeit('Schätzen',5,4,5,61,0,0,i,CheckListBox3);
 ...
 If heimat = 0 Then
  Begin
   ...
   faehigkeit('Überleben',5,6,5,21,0,0,i,CheckListBox3);
  End;
     i:=4;
 If heimat = 0 Then
  Begin
 ...
 Else
  ...
  End;
 faehigkeit('Verführen',7,6,7,61,8,21,i,CheckListBox3);

 //-----------------------------------Ungewöhnliche_Kenntnisse-----
 ...
 faehigkeit('Erzählen',5,8,5,31,7,31,i,CheckListBox4);
 ...
 faehigkeit('Geländelauf',3,10,3,31,0,0,i,CheckListBox4);
 ...
 faehigkeit('Überleben',5,6,5,21,0,0,i,CheckListBox4);
 ...
 faehigkeit('Geheimmechanismen öffnen',5,4,5,61,0,0,i,CheckListBox4);
 faehigkeit('Glücksspiel',2,15,2,61,0,0,i,CheckListBox4);
 faehigkeit('Kräuterkunde',5,4,5,61,0,0,i,CheckListBox4);
 ...
 faehigkeit('Schätzen',5,4,5,61,0,0,i,CheckListBox4);
 faehigkeit('Schleichen',3,6,3,61,0,0,i,CheckListBox4);
 faehigkeit('Schlösser öffnen',2,6,2,61,0,0,i,CheckListBox4);
 ...
 faehigkeit('Verhören',7,4,7,61,0,0,i,CheckListBox4);
 ...
 faehigkeit('Beidhändiger Kampf',3,3,3,61,0,0,i,CheckListBox4);
 faehigkeit('Fälschen',2,12,2,61,0,0,i,CheckListBox4);
 ...
 faehigkeit('Scharfschießen',2,4,2,61,0,0,i,CheckListBox4);
 faehigkeit('Schiffsführung',5,6,5,31,7,61,i,CheckListBox4);
 ...
 faehigkeit('Geschäftstüchtigkeit',5,6,5,31,0,0,i,CheckListBox4);
 faehigkeit('Kampf in Vollrüstung',1,10,1,61,0,0,i,CheckListBox4);
 ...
 faehigkeit('Schießen vom Streitwagen',2,10,2,31,0,0,i,CheckListBox4);
...
begin
 ...
 Label5.Caption:='Ungewöhniche Kenntnisse (' + IntToStr(MPUk) + '/' + IntToStr(PUk) + ')';
end;
